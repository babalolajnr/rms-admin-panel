<template>
  ...
  >
    <div class="flex space-x-5">
      ...
      ><input
        class="font-bold w-96 bg-transparent outline-none"
        placeholder="Search"
      />
    </div>
    <div class="flex space-x-3">
      <div class="flex flex-col text-sm text-right justify-center">
        <span class="font-bold">Abdulqudduus Babalola</span
